...
pagerank_ = ['pagerankc', 'pagerankl', 'pagerankt']

seeds = [5,10,20,50,100]
#,10,20,50,100

OPEN_DIR = 'output_old/{}_pagerank-{}-{}-{}.csv.out'

WRITE_DIR = 'weight_{}_{}.csv'
...
for seed in seeds:
    for bytype in range(3):
        ...
        for ratio in range(11):
            ...
            with open(OPEN_DIR.format(types[bytype], pagerank_[bytype], seed, ratio/10), 'r') as read_file:
        ...
        with open (WRITE_DIR.format(seed, pagerank_[bytype]), 'w') as writefile:
