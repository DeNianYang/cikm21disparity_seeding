...
file_node = 'only_post/students_edges_tag.csv'
file_label = 'DT_node.csv'


out = []
out1 = []

out_dir = 'only_post/line_student_tag.csv'

out_dir2 = 'only_post/line_student_tag_label.csv'
# read in profile
with open(file_node, 'r') as read_file:
    #next(read_file)
    for line in read_file:
        token = line.strip().split(",")
        out.append((token[0], token[1], token[2]))

with open(out_dir, 'w') as writefile:
...
'''
line2write = []
OUTPUT_DIR = 'only_post/students_labels.csv'
