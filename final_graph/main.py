...
FILE_READ = 'result_50.csv'
# like and comment
male_spread_list = [[[] for j in range(5)] for i in range(3)]
female_spread_list = [[[] for j in range(5)] for i in range(3)]
...
for algo in range(5):
    ...
    elif algo == 3: algo_str = 'parity'
    elif algo == 4: algo_str = 'agnostic'
...
def plotting(action_retrival, action_str):
    p1 = figure(
        ...
        # x_axis_label='Target Ratio(Female) - {}'.format(action_str)
        )
    ...
    p1.line(idx4, y4, line_width=5, color='yellow', line_dash="4 4")
    ...
    export_svgs(p1, filename="fig/parento_frontier_{}_{}_50_final.svg".format(action_str, PF))
