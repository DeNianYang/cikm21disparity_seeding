        ...
        if edge_type in post_type:
            ...
            if usr1 in gender_dict:
                if usr2 in gender_dict:
                    ...
                    if int(y) * 12 + int(m) < 2012*12+8:
                        out += 1

                    if int(y) * 12 + int(m) > max_time:
                        max_time = int(y) * 12 + int(m)

                    elif int(y) * 12 + int(m) < min_time:
                        min_time = int(y) * 12 + int(m)
...
print (edge_count)
print("interval")
print(max_time/12, max_time%12)
print(min_time/12, min_time%12)
print("out")
print(out)
