...
class studentDataset(object):
    ...
    def _load(self):
        idx_features_labels = np.genfromtxt("social_inference/student_preprocess/all/students_labels.csv",
                                            dtype=np.dtype(str),
                                            delimiter=',')
        ...
        edges_unordered = np.genfromtxt("social_inference/student_preprocess/all/students_edges_comment.csv",
                                        dtype=np.int32,
                                        delimiter=',')[:, 0:-1]
        ...
        self.train_mask = _sample_mask(range(140 * 2/3), labels.shape[0])
